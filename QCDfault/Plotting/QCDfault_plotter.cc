...
int main ()
{
  ...
  THStack *hs_1VL = new THStack("hs_1VL", "1VL QCD, Distinguished by Gen H_{T}");
  THStack *hs_2VL = new THStack("hs_2VL", "2VL QCD, Distinguished by Gen H_{T}");
  THStack *hs_3VL = new THStack("hs_3VL", "3VL QCD, Distinguished by Gen H_{T}");
  THStack *hs_12VL = new THStack("hs_12VL", "12VL QCD, Distinguished by Gen H_{T}");
  THStack *hs_13VL = new THStack("hs_13VL", "13VL QCD, Distinguished by Gen H_{T}");
  THStack *hs_14VL = new THStack("hs_14VL", "14VL QCD, Distinguished by Gen H_{T}");
  THStack *hs_15VL = new THStack("hs_15VL", "15VL QCD, Distinguished by Gen H_{T}");

  THStack *hs_1L = new THStack("hs_1L", "1L QCD, Distinguished by Gen H_{T}");
  THStack *hs_2L = new THStack("hs_2L", "2L QCD, Distinguished by Gen H_{T}");
  THStack *hs_3L = new THStack("hs_3L", "3L QCD, Distinguished by Gen H_{T}");
  THStack *hs_4L = new THStack("hs_4L", "4L QCD, Distinguished by Gen H_{T}");
  THStack *hs_5L = new THStack("hs_5L", "5L QCD, Distinguished by Gen H_{T}");
  THStack *hs_6L = new THStack("hs_6L", "6L QCD, Distinguished by Gen H_{T}");
  THStack *hs_7L = new THStack("hs_7L", "7L QCD, Distinguished by Gen H_{T}");
  THStack *hs_8L = new THStack("hs_8L", "8L QCD, Distinguished by Gen H_{T}");
  THStack *hs_9L = new THStack("hs_9L", "9L QCD, Distinguished by Gen H_{T}");
  THStack *hs_10L = new THStack("hs_10L", "10L QCD, Distinguished by Gen H_{T}");
  THStack *hs_11L = new THStack("hs_11L", "11L QCD, Distinguished by Gen H_{T}");

  THStack *hs_1M = new THStack("hs_1M", "1M QCD, Distinguished by Gen H_{T}");
  THStack *hs_2M = new THStack("hs_2M", "2M QCD, Distinguished by Gen H_{T}");
  THStack *hs_3M = new THStack("hs_3M", "3M QCD, Distinguished by Gen H_{T}");
  THStack *hs_4M = new THStack("hs_4M", "4M QCD, Distinguished by Gen H_{T}");
  THStack *hs_5M = new THStack("hs_5M", "5M QCD, Distinguished by Gen H_{T}");
  THStack *hs_6M = new THStack("hs_6M", "6M QCD, Distinguished by Gen H_{T}");
  THStack *hs_7M = new THStack("hs_7M", "7M QCD, Distinguished by Gen H_{T}");
  THStack *hs_8M = new THStack("hs_8M", "8M QCD, Distinguished by Gen H_{T}");
  THStack *hs_9M = new THStack("hs_9M", "9M QCD, Distinguished by Gen H_{T}");
  THStack *hs_10M = new THStack("hs_10M", "10M QCD, Distinguished by Gen H_{T}");
  THStack *hs_11M = new THStack("hs_11M", "11M QCD, Distinguished by Gen H_{T}");

  THStack *hs_1H = new THStack("hs_1H", "1H QCD, Distinguished by Gen H_{T}");
  THStack *hs_2H = new THStack("hs_2H", "2H QCD, Distinguished by Gen H_{T}");
  THStack *hs_3H = new THStack("hs_3H", "3H QCD, Distinguished by Gen H_{T}");
  THStack *hs_4H = new THStack("hs_4H", "4H QCD, Distinguished by Gen H_{T}");
  THStack *hs_5H = new THStack("hs_5H", "5H QCD, Distinguished by Gen H_{T}");
  THStack *hs_6H = new THStack("hs_6H", "6H QCD, Distinguished by Gen H_{T}");
  THStack *hs_7H = new THStack("hs_7H", "7H QCD, Distinguished by Gen H_{T}");
  THStack *hs_8H = new THStack("hs_8H", "8H QCD, Distinguished by Gen H_{T}");
  THStack *hs_9H = new THStack("hs_9H", "9H QCD, Distinguished by Gen H_{T}");
  THStack *hs_10H = new THStack("hs_10H", "10H QCD, Distinguished by Gen H_{T}");
  THStack *hs_11H = new THStack("hs_11H", "11H QCD, Distinguished by Gen H_{T}");

  THStack *hs_1UH = new THStack("hs_1UH", "1UH QCD, Distinguished by Gen H_{T}");
  THStack *hs_2UH = new THStack("hs_2UH", "2UH QCD, Distinguished by Gen H_{T}");
  THStack *hs_3UH = new THStack("hs_3UH", "3UH QCD, Distinguished by Gen H_{T}");
  THStack *hs_4UH = new THStack("hs_4UH", "4UH QCD, Distinguished by Gen H_{T}");
  THStack *hs_5UH = new THStack("hs_5UH", "5UH QCD, Distinguished by Gen H_{T}");
  THStack *hs_6UH = new THStack("hs_6UH", "6UH QCD, Distinguished by Gen H_{T}");
  THStack *hs_7UH = new THStack("hs_7UH", "7UH QCD, Distinguished by Gen H_{T}");
  THStack *hs_8UH = new THStack("hs_8UH", "8UH QCD, Distinguished by Gen H_{T}");
  THStack *hs_9UH = new THStack("hs_9UH", "9UH QCD, Distinguished by Gen H_{T}");
  THStack *hs_10UH = new THStack("hs_10UH", "10UH QCD, Distinguished by Gen H_{T}");
  THStack *hs_11UH = new THStack("hs_11UH", "11UH QCD, Distinguished by Gen H_{T}");
