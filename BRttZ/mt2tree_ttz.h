...
#ifndef mt2tree_ttz_h
#define mt2tree_ttz_h
...
#ifdef mt2tree_ttz_cxx
mt2tree_ttz::mt2tree_ttz(TTree *tree) : fChain(0) 
{
   Init(tree);
}

mt2tree_ttz::~mt2tree_ttz()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t mt2tree_ttz::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t mt2tree_ttz::LoadTree(Long64_t entry)
{
...
void mt2tree_ttz::Init(TTree *tree)
{
...
void mt2tree_ttz::Show(Long64_t entry)
{
...
Int_t mt2tree_ttz::Cut(Long64_t entry)
{
