...
for SAMPLE in ${T2Samples[@]}; do
    eval 'nohup nice -n 10 ./MyLooper.exe < SignalRunLists/${SAMPLE}_mst800_mx600.txt >& logs/${SAMPLE}_mst800_mx600_log.txt &'
    eval 'nohup nice -n 10 ./MyLooper.exe < SignalRunLists/${SAMPLE}_mst1200_mx200.txt >& logs/${SAMPLE}_mst1200_mx200_log.txt &'
done

eval 'nohup nice -n 10 ./MyLooper.exe < SignalRunLists/T2cc_mst600_mx550.txt >& logs/T2cc_mst600_mx550_log.txt &'
